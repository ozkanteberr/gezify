// ignore_for_file: override_on_non_overriding_member, unused_local_variable, unused_label, must_be_immutable, body_might_complete_normally_nullable
          ...
          key: _formKey,
           child: Column(
            ...
            CustomTextField(
              ...
              validator: (value) {
                  if (value !.isEmpty) {
                    return 'Bilgileri eksiksiz dolrudunuz';
                  }
                  else{}
                  onSaved: (value){
                    password=value;
